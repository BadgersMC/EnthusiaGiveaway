...
class NoOpCelebrationBroadcaster : CelebrationBroadcaster {
    override fun announce(giveaway: Giveaway, winners: List<WinnerHandle>) { /* tests only */ }
    override fun notifyCancellation(giveaway: Giveaway) { /* tests only */ }
    override fun notifyNew(giveaway: Giveaway) { /* tests only */ }
}
